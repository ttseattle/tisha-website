var hsl = {
	...
	projects: "<dl> 							<dt> PNR Website </dt>							<dd> Responsive website for the National Network of Libraries of Medicine, Pacific Northwest Region. Based on the PNR blog, <a href='http://nnlm.gov/pnr/dragonfly/' target='_blank'> Dragonfly </a>, and developed using Wordpress. </dd>	<img src='img/pnr_mobile2.jpg' class='display' data-toggle='modal' data-target='#pnr-mobile-modal'/> <img src='img/pnr_web.png' class='display' data-toggle='modal' data-target='#pnr-web-modal'/> </dl> <dl> <dt> RRAIN Washington for Android </dt> <dd> Android application for awareness and recovery of natural disasters in Washington state. </dd> <img src='img/rrain_list.png' class='display' data-toggle='modal' data-target='#rrain_list-modal'/> <img src='img/rrain_info.png' class='display' data-toggle='modal' data-target='#rrain_info-modal'/> </dl>",
...
var access = {
	...
	projects: "<dl> 							<dt> ASL Search </dt>							<dd> Search engine for signs in American Sign Language. Instead of typing words into a search box, features are selected in a form. </dd> <img src='img/asl_results.png' class='display' data-toggle='modal' data-target='#asl-results-modal'/> </dl>",
